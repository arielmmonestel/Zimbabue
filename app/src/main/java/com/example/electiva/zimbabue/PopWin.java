...
public class PopWin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        TextView myTexto = (TextView) findViewById(R.id.pw1);
        TextView myTexto2 = (TextView) findViewById(R.id.pw2);
        myTexto2.setText(String.valueOf(jugadorEnTurno));
        myTexto2.setTypeface(textNumero);
